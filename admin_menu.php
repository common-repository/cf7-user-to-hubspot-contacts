...
echo'<table class="form-table">
		<tr>
			<td align="center"><a href="'.admin_url().'/options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'&wm_mchp_companies"     ><b>'.__('Company list', 'wm_cf7_userto_hubspot').'</b></a></td>
			<td align="center"><a href="'.admin_url().'/options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'&wm_mchp_contacts"      ><b>'.__('Contact list', 'wm_cf7_userto_hubspot').'</b></a></td>
			<td align="center"><a href="'.admin_url().'/options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'&wm_mchp_audienceadusr" ><b>'.__('Add new Contact to Company', 'wm_cf7_userto_hubspot').'</b></a></td>
			<td align="center"><a href="'.admin_url().'/options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'&wm_mchp_cf7"           ><b>'.__('CF7 Integration', 'wm_cf7_userto_hubspot').'</b></a></td>
			<td align="center"><a href="'.admin_url().'/options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'&wm_mchp_credapi"       ><b>'.__('Credentials to API HubSpot', 'wm_cf7_userto_hubspot').'</b></a></td>
		<tr>
	</table>
	<div class="wrap">';
...
if($tab==5){
	if( isset($_POST['wm_hs_acces_submit']) && isset( $_POST['hubspot_key'] ) ){
		\WM_CF7USRTOHS_ns\WM_CF7USRTOHS::wm_update_key( $_POST['hubspot_key'] );
	}
