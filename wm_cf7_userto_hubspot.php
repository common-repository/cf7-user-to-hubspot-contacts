...
add_action('init','WMufn_USRTOHS_i18n_init');
...
function WMufn_plugin_settings_link($links) { 
	$settings_link = '<a href="options-general.php?page='.esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ).'">'.__('Settings', 'wm_cf7_userto_hubspot').'</a>'; 
...
function WMufn_reg_menu(){
	add_submenu_page('options-general.php', 'HubSpot', 'HubSpot', 'administrator', esc_url( \WM_CF7USRTOHS_ns\WM_CF7USRTOHS::$suf ), 'WMufn_wm_out_menu');
}
